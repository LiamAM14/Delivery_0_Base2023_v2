...
public class Config {
	...
	public final static int numeroRestaurantes = 5;		// número de restaurantes a crear
	public final static int numeroPedidos = 5;			// número de pedidos por canal a crear
	public final static int numeroMoteros = 2;			// número de moteros por restaurante a crear
